(function () {
    console.log('📦 Zerocart: Intentando cargar loader en Checkout...');

    // Función para buscar el ID en varios lugares comunes de Tiendanube (incluyendo el entorno de checkout)
    ...
    if (!storeId) {
        console.error('❌ Zerocart: No se pudo encontrar el Store ID en el Checkout.');
        return;
    }

    console.log('✅ Zerocart: Store ID encontrado (Checkout):', storeId);
